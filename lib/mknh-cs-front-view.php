...
function mknh_cs_front_view()
{
    $content = get_option('mknh_cs_options');
    $mailing_list = get_option('mknh_cs_mailing_options');
    $general = get_option('mknh_cs_options_settings'); ?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="<?php echo plugins_url('lib/css/mknh-cs.css', dirname(__FILE__)); ?>">
        <link rel="stylesheet" href="<?php echo plugins_url('lib/css/bootstrap.css', dirname(__FILE__)); ?>">
        <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css" rel="stylesheet">
        <link href='http://fonts.googleapis.com/css?family=Grand+Hotel' rel='stylesheet' type='text/css'>
        <?php
        
        $design_options = get_option('mknh_cs_design_options');
        echo '<style>';
                        ...
                        <li class="dropdown">
                            <a class="dropdown-toggle" data-toggle="dropdown"
                               href="#">
                                ...
                                <?php _e('Email','mknh-cs'); ?>
                                <b class="caret"></b>
                            </a>
                            <ul class="dropdown-menu">
                                <form class="sendmailform" method="post" action="">
                                    <input type="email" class="form-control"
                                           placeholder="<?php _e('Send to Email', 'mknh-cs'); ?>" name="mknh_cs_email"
                                           id="mknh_cs_email"/>
    ...
    <div class="main<?php if($mailing_list['enable']==1): ?> main-mailchimp<?php endif; ?>">
        ...
        <div class="container">
            ...
            <div class="content">
                <h4 class="motto"><?php echo $content['abouttext']; ?>
                </h4>
                <?php if($mailing_list['enable']==1): ?>
                <div class="subscribe">
                    <h5 class="info-text">
                        <?php _e('Join the waiting list for the beta. We keep you posted.','mknh-cs'); ?>
                    </h5>
                    <div class="row">
                        <div class="col-md-4 col-md-offset-4 col-sm6-6 col-sm-offset-3 ">
                            <form class="form-inline" role="form" method="post" action="">
                                <div class="form-group">
                                    <label class="sr-only" for="nl_mail"><?php _e('Email address','mknh-cs'); ?></label>
                                    <input type="email" name="nl_mail" class="form-control transparent" placeholder="<?php _e('Your email here...','mknh-cs'); ?>">
                                </div>
                                <button type="submit" class="btn btn-danger btn-fill"><?php _e('Notify Me','mknh-cs'); ?></button>
                            </form>
        ...
        <div class="footer">
            <div class="container">
                ...
                Made with <i class="fa fa-heart heart"></i> by <a href="https://www.mknh.net">MKNH</a>.</a>
                <?php endif; ?>
            </div>
        </div>
    </div>
